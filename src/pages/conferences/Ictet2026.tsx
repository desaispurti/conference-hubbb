...
const conferenceData = {
  ...
  speakers: [
    ...
    { name: "Yesha Patel", org: "Senior Solution Architect", country: "United States", img: "https://static.wixstatic.com/media/30814e_8bd1ad53a6504ac999bc2116cebfe346~mv2.jpg" }
  ],
  tracks: [
