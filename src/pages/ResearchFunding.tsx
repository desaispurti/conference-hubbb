...
const ResearchFunding = () => {
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="container py-12 pt-20">
        <div className="text-center max-w-3xl mx-auto mb-10">
          ...
          <h2 className="text-3xl md:text-5xl font-serif font-bold text-primary mb-4">Official Press Release</h2>
          <p className="text-lg text-muted-foreground">Eminsphere Global Grant Programs 2026 Featured In Major Publications</p>
        </div>
        <div className="max-w-4xl mx-auto bg-card rounded-[2rem] p-6 md:p-10 shadow-elegant border border-border hover:border-primary/30 transition-colors">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="space-y-4">
              <a href="https://hindustanmetro.com/international-research-funding-applications-invited-under-eminsphere-global-grant-programs-2026" target="_blank" rel="noreferrer" className="block p-5 rounded-2xl bg-muted/50 border border-border hover:border-primary/50 hover:bg-primary/5 transition-all group hover:-translate-y-1 shadow-sm hover:shadow-md">
                <h4 className="font-bold text-foreground group-hover:text-primary transition-colors line-clamp-3 mb-3">International Research Funding Applications Invited Under Eminsphere Global Grant Programs 2026</h4>
                <div className="flex justify-between items-center text-sm text-muted-foreground">
                  <span className="font-bold text-accent uppercase tracking-wider text-xs">Hindustan Metro</span>
                  <span className="flex items-center gap-1 font-medium group-hover:text-primary transition-colors">Read Article <FileText className="h-4 w-4" /></span>
                </div>
              </a>
              <a href="https://trendinsider.in/2026/05/13/eminsphere-opens-research-funding-applications-for-2026-grant-cycle/" target="_blank" rel="noreferrer" className="block p-5 rounded-2xl bg-muted/50 border border-border hover:border-primary/50 hover:bg-primary/5 transition-all group hover:-translate-y-1 shadow-sm hover:shadow-md">
                <h4 className="font-bold text-foreground group-hover:text-primary transition-colors line-clamp-3 mb-3">Eminsphere Opens Research Funding Applications for 2026 Grant Cycle</h4>
                <div className="flex justify-between items-center text-sm text-muted-foreground">
                  <span className="font-bold text-accent uppercase tracking-wider text-xs">Trend Insider</span>
                  <span className="flex items-center gap-1 font-medium group-hover:text-primary transition-colors">Read Article <FileText className="h-4 w-4" /></span>
                </div>
              </a>
            </div>
